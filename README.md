...
- **React 19 + TypeScript** – Modern UI development with type safety
...
- **React Type Animation** – Typing animation effect on the homepage
- **Axios** – HTTP client (prepared for future API integrations)
