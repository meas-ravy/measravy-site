...
export default function Home() {
  ...
  const tracks = [
    {
      title: "Sims - Miquela Remix",
      artist: "Lauv, Miquela",
      explicit: true,
      bgClass: "bg-red-800",
      accentClass: "text-red-800",
      coverSrc: "/images/img_1.jpg",
    },
    {
      title: "Skrr (feat. GISELLE)",
      artist: "HAON, GISELLE",
      explicit: false,
      bgClass: "bg-neutral-600",
      accentClass: "text-neutral-700",
      coverSrc: "/images/img_3.jpg",
    },
    {
      title: "Socialite",
      artist: "Post Malone",
    ...
    >
      ...
      <div className="space-y-5">
        <div className="space-y-4">
          <TypeAnimation
            sequence={["hello, Ravy here", 2000]}
            wrapper="h1"
            speed={50}
            className="text-4xl sm:text-4xl font-semibold tracking-tight text-slate-900 dark:text-white"
            repeat={Infinity}
          />
          <motion.p
            className="max-w-xl text-lg font-medium leading-relaxed text-slate-600 dark:text-slate-200"
            variants={SECTION_SUB_Title}
          >
            ...
            <div className="flex items-center justify-between gap-6">
              ...
              >
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-full border-2 border-white/70 bg-transparent transition hover:bg-white/10">
                  <Plus className="h-5 w-5 cursor-pointer" strokeWidth={2.5} />
                </span>
                Save on Spotify
              </button>
